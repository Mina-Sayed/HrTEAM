...
export const authAdminEmployee = (type: string, mode?: string) =>
    async function (req: AuthenticatedReq, res: Response, next: NextFunction)
    {
        ...
        if (type === 'employee' || type === 'admin') {
            const error = {
                error_en: `You cannot (add or update or get or delete) any ${type} in this( branch , company , department) because you are not the owner of the company has this (branch , department )`,
            };
